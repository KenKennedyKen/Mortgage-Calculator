    ...
    while True:
        ...
        if command == 'n':
            ...
            try:
                ...
                print(f'Then that decimal is divided by the billing cycles in a year.\n {r_input/100}/12={r_input/100/12} \nIt is an annual interest rate, meaning an interest rate for the whole year.')
                print('So however many billing cycles are in the year (here we assume 12), the annual rate is divided into that many pieces.')
            ...
            while True:
                ...
                print('3. Clear custom payment history.')
                ...
                if choice == '1':
                    ...
                    custom_payments={}
                    print('Custom payment history cleared.')
                elif choice == '4':
                    print('\nReturning to Mortgage Calculator Menu with the following Custom Payments:\n')
